...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="container-fluid">
            ...
            <form action="/educationsystem/TeacherQueryName" class="navbar-form navbar-left">
                <div class="input-group">
                    <input type="text" value="${TeacherQueryName}" name="t_name" class="form-control"
                ...
                <table class="table table-striped">
                    ...
                    <c:forEach items="${TeacherList}" var="item">
                        <tr>
                            ...
                            <td>${item.l_name}</td>
                            <td>${item.t_phone}</td>
                            <td>${item.t_password}</td>
                            <td>
                                <button type="button" class="btn btn-success">
                                    <a href="/educationsystem/TeacherToUpdate?t_id=${item.t_id}">编辑</a>
                                </button>
                                <button type="button" class="btn btn-danger">
                                    <a href="/educationsystem/TeacherDelete?t_id=${item.t_id}">删除</a>
                                </button>
                            </td>
