            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="panel">
                        ...
                        <form action="/educationsystem/TeacherUpdate">
                            <div class="panel-body">
                                ...
                                <br> 性别： <label class="fancy-radio"> <input
                                    ...
                                    <c:if test="${UpdateTeacher.t_sex=='男'}">checked="checked"</c:if>>
                                <span><i></i>男</span>

                            </label> <label class="fancy-radio">
                                <input name="t_sex" value="女" type="radio"
