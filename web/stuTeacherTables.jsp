...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="container-fluid">
            ...
            <form action="/educationsystem/stuTeacherQueryName" class="navbar-form navbar-left">
                <div class="input-group">
                    <input type="text" value="${stuTeacherQueryName}" name="t_name" class="form-control"
            ...
            <div id="navbar-menu">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown"><a href="#" class="dropdown-toggle"
                        ...
                        <span>${login_student.s_name}</span> <i
