...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="container-fluid">
            <form action="/educationsystem/stuLessonQueryName" class="navbar-form navbar-left">
                <div class="input-group">
                    <input type="text" value="${stuLessonQueryName}" name="l_name" class="form-control"
