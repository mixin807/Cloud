...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="container-fluid">
            <form action="/educationsystem/teaLessonQueryName" class="navbar-form navbar-left">
                <div class="input-group">
                    <input type="text" value="${teaLessonQueryName}" name="l_name" class="form-control"
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-success">
                                    <a href="/educationsystem/teaLessonToUpdate?l_id=${item.l_id}">编辑</a>
                                </button>
                                <button type="button" class="btn btn-danger">
                                    <a href="/educationsystem/teaLessonDelete?l_id=${item.l_id}">删除</a>
                                </button>
                            </td>
                        </tr>
                    </c:forEach>
