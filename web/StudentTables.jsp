...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="container-fluid">
            ...
            <form action="/educationsystem/StudentQueryName" class="navbar-form navbar-left">
                <div class="input-group">
                    <input type="text" value="${StudentQueryName}" name="s_name" class="form-control"
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-success">
                                    <a href="/educationsystem/StudentToUpdate?s_id=${item.s_id}">编辑</a>
                                </button>
                                <button type="button" class="btn btn-danger">
                                    <a href="/educationsystem/StudentDelete?s_id=${item.s_id}">删除</a>
                                </button>
                            </td>
                        </tr>
                    </c:forEach>
