...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="container-fluid">
            ...
            <form action="/educationsystem/LessonQueryName"
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="panel">
                        ...
                        <form action="/educationsystem/teaLessonUpdate">
                            <div class="panel-body">
                                <input type="hidden" name="l_id" value="${UpdateLesson.l_id}">
                                课程名：<input type="text" name="l_name" class="form-control"
                                           placeholder="请输入课程名" value="${UpdateLesson.l_name}">
                                <br>课程时间：<input type="text" value="${UpdateLesson.l_time}"
                                          name="l_time" class="form-control" placeholder="请输入课程时间">
                                <br> 授课教师：<input type="text" name="t_name"
                                               value="${UpdateLesson.t_name}" class="form-control"
                                               placeholder="请输入授课教师">
                                <br> 课程描述： <input type="text" name="l_describe" class="form-control"
                                                  value="${UpdateLesson.l_describe}" placeholder="请输入课程描述">
                            </div>
                            <div class="row">
