                ...
                <div class="left">
                    <div class="content">
                        <div class="header">
                            ...
                            <p class="lead">Login your 教师端用户</p>
                        </div>
                        <form class="form-auth-small" action="/educationsystem/TeacherLogin">
                            ...
                            <div class="bottom">
                                <span class="helper-textright"><a
                                        href="teacherRegister.jsp">teacherRegister</a></span>
                            </div>
                        </form>
                    </div>
                </div>
