...
<div id="wrapper">
    ...
    <div class="main">
        ...
        <div class="main-content">
            <div class="container-fluid">
                <h3 class="page-title">教务管理员模块</h3>
                <div class="row">
                    <!-- INPUTS -->
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">添加教务管理员</h3>
                        </div>
                        <!-- 表单用于提交数据  action="/educationsystem/ManagerInsert" -->
                        <form action="/educationsystem/ManagerInsert">
                            <div class="panel-body">
                                姓名：<input type="text" name="e_name" class="form-control"
                                          placeholder="请输入姓名"> <br> 密码：<input type="text"
                                                                              name="e_password" class="form-control"
                                                                              placeholder="请输入密码">
                                <br>
                            </div>
                            <div class="row">
